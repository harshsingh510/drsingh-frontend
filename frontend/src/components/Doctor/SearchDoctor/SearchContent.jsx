            ...
            <div className='d-flex p-3 justify-content-between'>
                <div className='d-flex gap-3'>
                    ...
                    <div className="doc-info">
                        ...
                        {/* <p className="doc-department m-0"><img src={showImg} className="img-fluid" alt="Speciality" />{data?.speciality}</p> */}
                ...
                <div className="doc-info-right me-3">
                    <div className="clini-infos">
                        <ul>
                            ...
                            <li><FaRupeeSign /> {data?.price ? truncate(data?.price, 4) : 60} (30 minutes)</li>
                        </ul>
                    </div>
