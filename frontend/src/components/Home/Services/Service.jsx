    ...
    return (
        <section className="container" style={{marginTop: 200, marginBottom:200}}>
            <div className='mb-5 section-title text-center'>
                <h2>Services</h2>
                <p className='m-0'>Here are the services offered by us, additionally you can consult for other services</p>
            </div>
                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-4">
                        <div className="service-content ps-4 mt-4 mt-lg-0">
                            ...
                            <p className="mt-4 mb-5 text-secondary form-text">We are a leading online medical service provider, delivering expert care and support tailored to your needs. Trust us for comprehensive health solutions.</p>
